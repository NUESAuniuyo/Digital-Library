    ...
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 text-center sm:text-left">
            <div className="flex flex-col sm:flex-row items-center sm:items-start sm:space-x-3">
              ...
              <div>
                <h3 className="text-lg font-bold mt-2 sm:mt-0">NUESA E-Library</h3>
      ...
      <div className="bg-gray-800 py-4">
        <div className="container-custom">
          <div className="bg-gray-700 rounded-lg p-4 h-20 flex items-center justify-center border-2 border-dashed border-gray-600 mx-4 sm:mx-0">
            <span className="text-sm text-gray-500 text-center">Google AdSense Banner - 728x90</span>
          </div>
        </div>
      </div>
    </footer>
